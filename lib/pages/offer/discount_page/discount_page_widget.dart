...
class DiscountPageWidget extends StatefulWidget {
  const DiscountPageWidget({super.key});

  @override
  State<DiscountPageWidget> createState() => _DiscountPageWidgetState();
}
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: FutureBuilder<ApiCallResponse>(
                                      future: BAppEuVendoGroup.getOfferByIdBCall
                                          .call(
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        child: ClipRRect(
                                                          ...
                                                          child: Image.network(
                                                            '${BAppEuVendoGroup.getOfferByIdBCall.imagemPNG(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              FlutterFlowDropDown<
                                                                  String>(
                                                                controller: _model
                                                                        .dropDowndiscountstatusValueController ??=
                                                                    FormFieldController<
                                                                            String>(
                                                                        null),
                                                                options: const [
                                                                ...
                                                                onChanged: (val) =>
                                                                    setState(() =>
                                                                        _model.dropDowndiscountstatusValue =
                                                                            val),
                                                                width: 180.0,
                                                                height: 50.0,
                                                        ...
                                                        _model.apiResultvo1 =
                                                          ...
                                                          discountvalue: int
                                                              .tryParse(_model
                                                                  .textController
                                                                  .text),
                                                          discountstatus: _model
                                                              .dropDowndiscountstatusValue,
                                                          discounttype: _model
                                                              .dropDowntypeValue,
                                                        );

                                                        if ((_model.apiResultvo1
                                                                ?.succeeded ??
                                                            true)) {
                                                          await showDialog(
                                                            context: context,

...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF463584);
  late Color secondary = const Color(0xFF733AAD);
  late Color tertiary = const Color(0xFFA6C24F);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFFF6F6F9);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFD8D8D8);
  late Color accent2 = const Color(0xFF848484);
